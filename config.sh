...
function editSetting {
  ...
  case $1 in
    ...
    3 ) read -p "Screen or Mouse: integer; format: 0-1;default: 0: " RES
	echo $RES | sudo tee ${PARM_DIR}/Screen_or_Mouse;;
    * ) quit;;
  esac
}
...
function viewSetting {
  case $1 in
    ...
    3 ) sudo cat ${PARM_DIR}/Screen_or_Mouse;;
    * ) quit;;
  esac
}
...
function init {
  ...
  while [ 1 ]; do
    ...
    select opt in "Orientation" "Screen mapping" "Pressure mapping" "Screen or Mouse" "(Anything else to quit)"; do
      case $opt in
        "Orientation" ) SETTING=0; break;;
        "Screen mapping" ) SETTING=1; break;;
        "Pressure mapping" ) SETTING=2; break;;
	"Screen or Mouse" ) SETTING=3; break;;
        * ) quit;;
      esac
    done
